...
class _summaryisiState extends State<summaryisi> {
 final List<String> productTitles = [
  ...
  List<int> selectedQuantities = List.generate(2, (index) => 1);
  List<String?> selectedVariations = List.generate(2, (index) => null);
                                 ...
                                 Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          RatingBar.builder(
                                              initialRating: productRatings[index],
                                              minRating: 1,
                                ...
                                overflow: TextOverflow.ellipsis,
                                  ...
                                  child: Text(
                                    ...
                                    overflow: TextOverflow.ellipsis,
                                             ...
                                             .toList(),
                                         value: selectedVariations[index],
                                  onChanged: (newValue) {
                                    setState(() {
                                      selectedVariations[index] = newValue;
                                    });
                                         },
