...
class ItemsWidget extends StatefulWidget {
  ...
  final Function sandwichPressedCart;
  final Function burgerPressedCart;
  ...
  ItemsWidget({
    ...
    required this.sandwichPressedCart,
    required this.burgerPressedCart,
  });
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => widget.sandwichPressed(),
                  ),
                ],
              ),
              InkWell(
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.shopping_cart_checkout,
                        color: Color.fromARGB(216, 0, 85, 255)),
                    onPressed: () => widget.sandwichPressedCart(),
                  ),
                ],
              ),
            ],
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    onPressed: () => widget.burgerPressed(),
                  ),
                ],
              ),
              InkWell(
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.shopping_cart_checkout,
                        color: Color.fromARGB(216, 0, 85, 255)),
                    onPressed: () => widget.burgerPressedCart(),
                  ),
                ],
              ),
            ],
